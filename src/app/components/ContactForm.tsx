...
import { Send, X, ShieldCheck, ChevronDown, Search } from 'lucide-react';
...
import FormStatusModal from './FormStatusModal'; // Asegúrate de haber creado este archivo
...
export default function ContactForm() {
  ...
  // Estado para el Pop-up de Éxito/Error
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Construcción del payload con metadatos técnicos y de origen
    const payload = {
    ...
    try {
      ...
      if (response.ok) {
        setStatusModal({ isOpen: true, type: 'success' });
        (e.target as HTMLFormElement).reset();
        setPhoneNumber(undefined);
      } else {
        setStatusModal({ isOpen: true, type: 'error' });
      }
    } catch (error) {
